...
const EXERCISE_DISMISS_ERROR = 'EXERCISE_DISMISS_ERROR';
const EXERCISES_CLEAR = 'EXERCISES_CLEAR';
export { 
  EXERCISE_GET, EXERCISE_EDIT, EXERCISE_ADD_SET, EXERCISE_ADD_COMMENT,
  EXERCISE_DISMISS_ERROR, EXERCISES_CLEAR, EXERCISE_DELETE_COMMENT
}
...
export const dismissExerciseError = (exerciseId) => ({
  type: EXERCISE_DISMISS_ERROR,
  id: exerciseId,
});
